...
//        this.ret = n.ret || "txt";
        ...
        this.on("input",function(msg) {
            ...
            if (nodeMarkread === "use"){
	            var markread = (typeof msg.markread === "undefined") ? "" : msg.markread;
            } else {
            	var markread = nodeMarkread;
        	}
            if (nodeMultipart === "use"){
	            var multipart = (typeof msg.multipart === "undefined") ? "" : msg.multipart;
            } else {
...
//            var method = nodeMethod.toUpperCase() || "GET";  //move up
    ...
    RED.nodes.registerType("document",HTTPRequest,{
        credentials: {
            user: {type:"text"},
