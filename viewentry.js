...
//        this.ret = n.ret || "txt";
        ...
        this.on("input",function(msg) {
            ...
            var method = nodeMethod.toUpperCase() || "PUT";
			...
			//{database}/api/data/collections/unid/{unid}/unid/{docunid}
			//{database}/api/data/collections/name/{name}/unid/{docunid}
			var baseUri= "api/data/collections"
            var url = encodeURI(setSlash( host ) + database + "/" + baseUri + "/" + opUri + "/unid/" + docunid);
			log("url", url);

			if (host === "" || database === "" || viewtype === "" || (viewtype === "unid" && viewunid === "") || (viewtype === "name" && viewname === "") || (viewunid === "" && viewname === "") || docunid ==="") {
				var errorparam = "";
				...
				errorparam = (docunid === "") ? errorparam + " docunid," : errorparam;
...
//            var method = nodeMethod.toUpperCase() || "GET";  //move up
    ...
    RED.nodes.registerType("view entry",HTTPRequest,{
        credentials: {
            user: {type:"text"},
